...

{
  ...
  backports-shutil-get-terminal-size_1_0_0 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl }:
     python.mkDerivation {
  ...
  distlib_0_2_7 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl }:
     python.mkDerivation {
       pname = "distlib";
       version = "0.2.7";
       src = fetchurl {
         url = "https://files.pythonhosted.org/packages/22/4c/135069c506ce80c37a4a30e755de0a9dc5e189eabc23f7092752657a9e93/distlib-0.2.7.zip";
  ...
  ipython_5_7_0 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, decorator, pickleshare, prompt-toolkit, pygments, setuptools, simplegeneric, traitlets, pexpect, backports-shutil-get-terminal-size, pathlib2, appnope }:
     python.mkDerivation {
       pname = "ipython";
       version = "5.7.0";
       src = fetchurl {
       ...
       pythonDepends = [ decorator pickleshare prompt-toolkit pygments setuptools simplegeneric traitlets pexpect ]
         ++ stdenv.lib.optional pythonPlatform.isPython27 backports-shutil-get-terminal-size
         ++ stdenv.lib.optional pythonPlatform.isPython27 pathlib2
         ++ stdenv.lib.optional stdenv.isDarwin appnope;
       meta = with stdenv.lib; {
  ...
  ipython_6_4_0 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, backcall, decorator, jedi, pickleshare, prompt-toolkit, pygments, setuptools, simplegeneric, traitlets, pexpect, typing, appnope }:
     python.mkDerivation {
       pname = "ipython";
       version = "6.4.0";
       src = fetchurl {
       ...
       pythonDepends = [ backcall decorator jedi pickleshare prompt-toolkit pygments setuptools simplegeneric traitlets pexpect ]
         ++ stdenv.lib.optional pythonPlatform.isPython27 typing
         ++ stdenv.lib.optional stdenv.isDarwin appnope;
       meta = with stdenv.lib; {
         description = "IPython: Productive Interactive Computing";
         homepage = "https://ipython.org";
  ...
  ipython-genutils_0_2_0 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl }:
     python.mkDerivation {
  ...
  jedi_0_12_0 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, parso }:
     python.mkDerivation {
       pname = "jedi";
       version = "0.12.0";
       src = fetchurl {
  ...
  jsonschema_2_6_0 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, vcversioner, functools32 }:
     python.mkDerivation {
       pname = "jsonschema";
       version = "2.6.0";
       src = fetchurl {
  ...
  lxml_4_2_1 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, libxml2, libxslt }:
     python.mkDerivation {
       pname = "lxml";
       version = "4.2.1";
       src = fetchurl {
  ...
  pathlib2_2_3_2 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, six, scandir }:
     python.mkDerivation {
       pname = "pathlib2";
       version = "2.3.2";
       src = fetchurl {
       ...
       pythonDepends = [ six ]
         ++ stdenv.lib.optional pythonPlatform.isPython27 scandir;
       meta = with stdenv.lib; {
  ...
  pexpect_4_5_0 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, ptyprocess }:
     python.mkDerivation {
       pname = "pexpect";
       version = "4.5.0";
       src = fetchurl {
  ...
  pickleshare_0_7_4 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, pathlib2 }:
     python.mkDerivation {
       pname = "pickleshare";
       version = "0.7.4";
       src = fetchurl {
       ...
       pythonDepends = stdenv.lib.optional pythonPlatform.isPython27 pathlib2;
       meta = with stdenv.lib; {
  ...
  prompt-toolkit_1_0_15 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, six, wcwidth }:
     python.mkDerivation {
  ...
  psutil_5_4_5 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, IOKit }:
     python.mkDerivation {
       pname = "psutil";
       version = "5.4.5";
       src = fetchurl {
       ...
       systemDepends = stdenv.lib.optional stdenv.isDarwin IOKit;
       meta = with stdenv.lib; {
  ...
  psycopg2_2_7_4 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, openssl, postgresql }:
     python.mkDerivation {
       pname = "psycopg2";
       version = "2.7.4";
       src = fetchurl {
       ...
       systemDepends = [ openssl postgresql ];
       meta = with stdenv.lib; {
  ...
  pyasn1-modules_0_2_1 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, pyasn1 }:
     python.mkDerivation {
  ...
  pynacl_1_2_1 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, libffi, cffi, six }:
     python.mkDerivation {
       pname = "PyNaCl";
       version = "1.2.1";
       src = fetchurl {
  ...
  python-ldap_3_0_0 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, cyrus_sasl, openldap, pyasn1, pyasn1-modules }:
     python.mkDerivation {
       pname = "python_ldap";
       version = "3.0.0";
       src = fetchurl {
         url = "https://files.pythonhosted.org/packages/c1/52/dfb508364bce92bb2a6ccbe718b69c8857b5d6fcd6af259ab0c36ee68730/python-ldap-3.0.0.tar.gz";
         sha256 = "86746b912a2cd37a54b06c694f021b0c8556d4caeab75ef50435ada152e2fbe1";
       };
       systemDepends = [ cyrus_sasl openldap ];
       pythonDepends = [ pyasn1 pyasn1-modules ];
  ...
  simplegeneric_0_8_1 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl }:
     python.mkDerivation {
       pname = "simplegeneric";
       version = "0.8.1";
  ...
  traitlets_4_3_2 = callPackage
    ({ python, pythonPlatform, stdenv, fetchurl, decorator, ipython-genutils, six, enum34 }:
     python.mkDerivation {
       pname = "traitlets";
       version = "4.3.2";
       src = fetchurl {
       ...
       pythonDepends = [ decorator ipython-genutils six ]
         ++ stdenv.lib.optional pythonPlatform.isPython27 enum34;
       meta = with stdenv.lib; {
